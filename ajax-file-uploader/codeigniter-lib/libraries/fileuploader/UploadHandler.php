    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if(isset($this->options['user'])){
                $this->new_name = $this->options['user']."---".time().mt_rand().$file->name;
            }else{
                $this->new_name = date('y-m-d')."---".time().mt_rand().$file->name;
            }
            
            $file_path = $this->get_upload_path($this->new_name);
